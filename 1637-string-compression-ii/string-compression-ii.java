    ...
    public int getLengthOfOptimalCompression(String s, int k) {
        ...
        for (int i = 1; i <= n; i++) {
            ...
            for (int j = 0; j <= k; j++) {
                ...
                for (int t = i; t >= 1; t--) {
                    if (s.charAt(t - 1) == s.charAt(i - 1)) count++; // Increment count if the characters are the same
                    else del++; // Increment deletion count if the characters are different
                    ...
                    if (j - del >= 0) {
                        ...
                        if (count >= 100) temp = 3; else if (count >= 10) temp = 2; else if (count >= 2) temp = 1;
