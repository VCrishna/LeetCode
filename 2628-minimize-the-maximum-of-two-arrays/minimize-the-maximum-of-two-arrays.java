class Solution {
    public int minimizeSet(int divisor1, int divisor2, int uniqueCnt1, int uniqueCnt2) {
        ...
        while (left <= right) {
            ...
            // LCM up to mid
            // x: Represents the count of numbers up to mid that are not divisible by divisor1.
            // y: Represents the count of numbers up to mid that are not divisible by  divisor2.
            // z: Represents the count of numbers up to mid that are not divisible by the
            // least common multiple (LCM) of divisor1 and divisor2.
